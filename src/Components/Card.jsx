...
const Card = ({ id, image, name, oldPrice, newPrice, desc }) => {
  return (
    <div className="group relative flex flex-col h-full bg-gray-200 rounded-2xl overflow-hidden">
      ...
      <div className="w-full p-4 flex flex-col flex-grow">
        <div>
          <div className="flex justify-between">
            ...
            <div className="flex">
              <del className="font-light mr-1">₹{oldPrice}</del>
        ...
        <button className="mt-auto px-3 py-2 w-full bg-green-400 rounded-2xl font-bold">
          Add to cart
        </button>
      </div>
    </div>
